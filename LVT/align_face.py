...
parser.add_argument('--dataset_dir', default="datasets/animefaces256cleaner/")
parser.add_argument('--save_dir', default="datasets/animefaces256cleaner_align/")
...
if __name__ == "__main__":
    ...
    for image_name in images:
        try:
            ...
            cv2.imwrite(save_path, align_face)
